   ...
   */
    ...
    public void enable(){
        jTextField1.setEnabled(true);
         ...
         jRadioButton3.setEnabled(false); //on button disable
    ...
    public void disable(){
        ...
        jRadioButton3.setEnabled(true); //on button enable
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String store;
        ...
        if (length>0) {
//            StringBulider vreates empty string bulider, which is used to store Strings
